  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: 600, fontSize: '1.18rem', textAlign: 'left' }}>
        ...
        <p>Want to be the first to know when applications open? Follow us on IG <a href="https://www.instagram.com/becauseitsfair/" target="_blank" rel="noopener noreferrer" style={{ color: '#000000', textDecoration: 'none' }}><strong>@becauseitsfair</strong></a>.</p>
